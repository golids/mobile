    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.description}>
          Find and Claim just in few taps!
        </Text>

        {/* Content with image */}
        <View style={styles.content}>
          <Image
            source={require("../assets/images/socmed.png")}
            style={styles.image}
            resizeMode="contain"
          />
        </View>
        ...
        <Text style={styles.additionalText}>
          Posting a lost or found item is quick and easy. Just add a short description, photo, and location, then let the campus community help. 
        </Text>
        <Text style={styles.additionalText}>
          You can browse the live feed to check for newly posted items or update the status of your own posts at any time.
        </Text>
      </ScrollView>
